...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"TuxCut Pro", pos = wx.DefaultPosition, size = wx.Size( 750,400 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.MINIMIZE_BOX )
